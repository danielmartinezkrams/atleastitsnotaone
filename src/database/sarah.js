...
const menuData = [
    ...
    },
    {
        ...
        "menu":[createData("Grilled Pork Sandwich", 3.45), createData("BBQ Chicken Sandwich", 3.45), createData("Tofu Sandwich", 2.75), createData("Steak Sandwich", 3.45), createData("Imperial Rolls (3)", 4.75), createData("Vietnamese Moon Crepe", 7.95), createData("Grilled Chicken Salad", 7.95), createData("Combo Beef Pho", 8.25), createData("Rare Sliced Beef Pho", 6.95), createData("Well-Done Beef Pho", 6.95), createData("Chicken Stir Fried Noodles", 7.95), createData("Beef Stir Fried Noodles", 7.95), createData("Chicken Fried Rice", 6.95), createData("Clay Pot Combo", 8.95), createData("Curry Chicken", 7.75), createData("Orange Flavored Chicken", 7.75), createData("Spicy Chicken", 7.75), createData("Lemon Grass Curry Chicken", 7.75), createData("Orange Flavored Beef", 7.95), createData("Beef In Coconut Milk", 7.95), createData("Bir'd Nest Crispy Noodles", 8.45), createData("Stir-Fried Noodles Tofu", 7.95), createData("Lemonade", 3), createData("Soft Drink", 1.25), createData("Grass Jelly", 1.50), createData("Thai Iced Tea", 2.75), createData("Iced Coffee", 3.00)]
    },
    {
        "name": "Fresco",
